defmodule Merlin.Accounts.User do
  @moduledoc """
  ...
  defp validate_qr(%{params: params} = changeset) do
    if Map.get(params, :role) == :attendee do
      ...
      |> unsafe_validate_unique(:qrcode, Merlin.Repo)
  ...
  """
  def valid_password?(%Merlin.Accounts.User{hashed_password: hashed_password}, password)
